...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp:"003", name:"Cochise", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"005", name:"Coconino", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"007", name:"Gila", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"013", name:"Maricopa", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: []},
    { countyfp:"015", name:"Mohave", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"017", name:"Navajo", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"019", name:"Pima", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"021", name:"Pinal", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"025", name:"Yavapai", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
    { countyfp:"027", name:"Yuma", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
];
