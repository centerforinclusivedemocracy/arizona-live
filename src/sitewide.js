...
const PARTICIPATING_COUNTIES = [
    { countyfp:"001", name:"Apache", profile: 'lite', outoforder:"Polling location modeling will be provided for this county soon", datafootnote:"", exceptlayers: [] },
...
DATA_LAYERS.triballands = {
    id: 'triballands',
    title: "Tribal Lands",
    customgeojsonfile: 'tribal.geojson',
